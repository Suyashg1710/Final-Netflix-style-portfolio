...
export const recruiterProjects: RecruiterProject[] = [
    ...
    assets: [
      {
        ...
        // YouTube thumbnail — replace EDtQFdFz76k with the actual video ID if different
        thumbnail: "https://img.youtube.com/vi/EDtQFdFz76k/hqdefault.jpg",
      },
      {
        type: "image",
  ...
  },
  {
    ...
    thumbnail: "/Mercedes-Benz-logo.jpeg",
    cover: "/MercedesGoat.png",
    assets: [
      {
        type: "embed",
        ...
        title: "Goat x Mercedes-Benz CLA",
        // YouTube thumbnail
        thumbnail: "https://img.youtube.com/vi/Ee1lKnGQ-50/hqdefault.jpg",
      },
    ],
  },
  {
